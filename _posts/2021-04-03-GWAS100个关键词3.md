...
&emsp;&emsp;在过去的15年中，全基因组关联研究（GWAS）能够系统得鉴定与性状或疾病相关的遗传基因座。然而，与性状相关的markers或者top variants有时候并不是真正影响我们研究性状的因果变异(causal variants)，因此确定这些causal variants才是困难之处。

fine-mapping方法都要保证这三大原则：
...
> [Fine-mapping详细介绍1](https://mp.weixin.qq.com/s/Vj_i7MSRsdN0JGTNTllPWw)、[Fine-mapping详细介绍2](https://zhuanlan.zhihu.com/p/106103885?utm_source=wechat_session)、[Fine-mapping详细介绍3](https://www.jianshu.com/p/f533318d4e23?from=singlemessage)、[Fine-mapping详细介绍4](https://mp.weixin.qq.com/s/iOO5UFRJL2fZmilzBMIGuQ)
